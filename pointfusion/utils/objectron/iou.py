...
https://github.com/google-research-datasets/Objectron/tree/master/objectron/dataset
...
class IoU(object):
    ...
    def iou_sampling(self, num_samples=10000):
        ...
        intersection_volume_estimate = (
            ...
            + box2_volume * box2_intersection_estimate
        ) / 2.0
        union_volume_estimate = (
            box1_volume * num_samples + box2_volume * num_samples
        ) - intersection_volume_estimate
